...
public class Variable implements Iterable<Integer> 
{
	...
	private Domain domain;	// changed from private to public 2/14
	...
	/**
	 * Removes a single value from the domain of V without trial
	 * @param val value to remove
	 */
	public void silentRemoveValueFromDomain(int val) {
		domain.remove(val);
	}
